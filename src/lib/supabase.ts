  ...
  public: {
    Tables: {
      ...
      cost_categories: {
        ...
        Insert: Omit<Database['public']['Tables']['cost_categories']['Row'], 'id' | 'created_at' | 'updated_at'>;
      ...
      litigation_costs: {
        ...
        Insert: Omit<Database['public']['Tables']['litigation_costs']['Row'], 'id' | 'created_at' | 'updated_at'>;
        Update: Partial<Database['public']['Tables']['litigation_costs']['Insert']>;
      };
      litigation_cost_documents: {
        ...
        Insert: Omit<Database['public']['Tables']['litigation_cost_documents']['Row'], 'id' | 'uploaded_at'>;
        Update: Partial<Database['public']['Tables']['litigation_cost_documents']['Insert']>;
      };
      litigation_cost_history: {
        ...
        Insert: Omit<Database['public']['Tables']['litigation_cost_history']['Row'], 'id' | 'changed_at'>;
        Update: Partial<Database['public']['Tables']['litigation_cost_history']['Insert']>;
      };
      groups: {
        Row: {
          id: string;
      ...
      group_module_permissions: {
        ...
        Insert: Omit<Database['public']['Tables']['group_module_permissions']['Row'], 'id' | 'created_at' | 'updated_at'>;
        Update: Partial<Database['public']['Tables']['group_module_permissions']['Insert']>;
      };
      user_groups: {
        Row: {
          id: string;
        ...
        Insert: Omit<Database['public']['Tables']['user_groups']['Row'], 'id' | 'assigned_at'>;
    ...
    Functions: {
      ...
      user_has_permission: {
        Args: { p_user_id: string; p_module_key: string; p_action: string };
        Returns: boolean;
      };
    };
  };
