...
const navigation = [
  ...
  { name: '4. Registration & Assignment', href: '/cases', icon: FolderOpen, tooltip: 'Litigation Officer workspace - all filings happen here' },
  { name: '5. Compliance', href: '/compliance', icon: CheckSquare, tooltip: 'Solicitor General/Legal Officers - may loop back to steps 2 & 4' },
  { name: '6. Case Closure', href: '/cases', icon: Shield, tooltip: 'Judgment and case closure' },
