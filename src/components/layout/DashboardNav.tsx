...
export function DashboardNav() {
  ...
  return (
    <nav className="sticky top-0 z-50 shadow-md" style={{ background: 'linear-gradient(135deg, #2d5f3f 0%, #4a8b5c 50%, #2d5f3f 100%)' }}>
      <div className="flex h-16 items-center px-4 lg:px-6">
        <div className="flex items-center gap-3 mr-8">
          <img
            src="/dlpp-logo.svg"
            alt="DLPP Logo"
            className="h-10 w-auto bg-white rounded-md p-1.5"
          />
