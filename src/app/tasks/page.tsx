...
import { CheckSquare, Plus, Clock, AlertCircle, Search, X } from 'lucide-react';
...
export default function TasksPage() {
  ...
  const getStatusBadge = (status: string) => {
    const variants: Record<string, { className: string; label: string; icon: typeof Clock }> = {
  ...
  const pendingTasks = filteredTasks.filter((t) => getTaskStatus(t) === 'pending');
          ...
          <div className="space-y-1">
            <div
              className={`flex items-center gap-2 ${
                isDueToday ? 'text-orange-600 font-medium' : 'text-slate-600'
              }`}
            >
            ...
            {task.cases && (
              <div className="text-xs text-slate-500 font-mono">Case: {task.cases.case_number}</div>
            )}
          </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold mt-1" style={{ color: '#D4A574' }}>
                    {pendingTasks.length}
                  </p>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold mt-1" style={{ color: '#4A4284' }}>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold mt-1" style={{ color: '#EF5A5A' }}>
                    {overdueTasks.length}
                  </p>
                </div>
        ...
        <Card className="border-0 shadow-sm">
          <CardContent className="p-4">
            <div className="relative">
              ...
              <Input
                type="text"
                placeholder="Search tasks by title, description, or case number..."
                value={searchQuery}
