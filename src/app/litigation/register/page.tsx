...
/**
 * DEPRECATED ROUTE
 * This route has been consolidated into /cases/new
 * Automatically redirects to the canonical route
 */
export default function LitigationRegisterPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="text-center">
        ...
        <p className="text-slate-600">Redirecting to Register Case...</p>
      </div>
    </div>
  );
}
