              ...
              <CardContent className="space-y-6">
                <div className="grid gap-6 md:grid-cols-2">
                  <SelectWithAdd
                    ...
                    label="Type of Matter (Item 7)"
                    placeholder="Select matter type (optional)"
                  />
              ...
              <CardContent className="space-y-6">
                <div className="grid gap-6 md:grid-cols-2">
                  <SelectWithAdd
                    ...
                    tableName="divisions"
                    label="Division Responsible (Item 10)"
              ...
              <CardContent className="space-y-6">
                <div className="grid gap-6 md:grid-cols-2">
                  <SelectWithAdd
                    ...
                    tableName="lawyers"
                    label={formData.dlpp_role === 'defendant' ? "Name of Plaintiff's Lawyers (Item 13)" : "Name of Defendant's Lawyer (Item 13)"}
                    placeholder="Select lawyer or firm"
                  />
                  ...
                  <SelectWithAdd
                    ...
                    label="Sol Gen Action Officer (Item 14)"
                    placeholder="Select Sol Gen officer"
                  />
                </div>
              </CardContent>
            </Card>
