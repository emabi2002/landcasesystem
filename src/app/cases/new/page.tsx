...
export default function NewCasePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Prepare case data with proper date/timestamp conversions
      const caseData = {
        ...formData,
      ...
      if (formData.returnable_date) {
        toast.success('Case registered successfully! Calendar event created with alert 3 days before returnable date.');
      } else {
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="p-6 lg:p-8 max-w-6xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-slate-600 mt-1">DLPP Litigation Case Registration - Complete workflow process</p>
        </div>
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      required
                    />
                    <p className="text-xs text-slate-500">Internal DLPP case tracking number</p>
                  </div>
            ...
            <Card className="border-2 border-emerald-200">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-slate-600 mt-4 text-center">
                  After registration, proceed to STEP 3 (Upload Documents) and STEP 4 (Create Tasks)
                </p>
              </CardContent>
            </Card>
          </div>
